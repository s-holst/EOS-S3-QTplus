...
int main(void)
{
    ...
    IOMUX->PAD_CTRL[0] = IOMUX_PAD_CTRL_CSEL_OTHER | IOMUX_PAD_CTRL_P_PULLUP | IOMUX_PAD_CTRL_E_4MA | IOMUX_PAD_CTRL_REN_ENABLE;
    IOMUX->PAD_CTRL[1] = IOMUX_PAD_CTRL_CSEL_OTHER | IOMUX_PAD_CTRL_P_PULLUP | IOMUX_PAD_CTRL_E_4MA | IOMUX_PAD_CTRL_REN_ENABLE;
    IOMUX->SDA0_SEL = 1;
    IOMUX->SCL0_SEL = 1;
